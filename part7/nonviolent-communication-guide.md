...
1. **NVC:** "When I see [behavior], I feel [feeling] because I need [need]. Would you be willing to [request]?"

2. **Relational Accountability:** "If you're not able to participate in this agreement, we'll need to pause your community participation while you access the support you need."
...
### NVC Formula
1. **Observation:** What I see/hear (no judgment)
2. **Feeling:** Emotion in my body (not thought)
3. **Need:** Universal human value (not strategy)
4. **Request:** Specific, actionable, truly optional
